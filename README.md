# RaaG - An app that can play songs using different radio channels. This app is integrated with Alan AI, so it also have the functionality of voice assistant.
