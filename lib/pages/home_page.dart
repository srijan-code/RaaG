...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "ed96faba0e37c382353a689665696bd32e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
            AppBar(
              title: "RaaG".text.xl4.bold.white.make().shimmer(
                  primaryColor: Vx.purple300, secondaryColor: Colors.white),
              backgroundColor: Colors.transparent,
              elevation: 0.0,
              centerTitle: true,
            ).h(100.0).p16(),
            "Begin by saying - Hey Alan 👇".text.bold.semiBold.white.make(),
            10.heightBox,
            VxSwiper.builder(
